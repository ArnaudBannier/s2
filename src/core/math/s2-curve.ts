...
export interface S2CurveOLD {
    ...
    createPartialCurveTo(t: number): S2CurveOLD;
    createPartialCurveFrom(t: number): S2CurveOLD;
    createPartialCurveRange(from: number, to: number): S2CurveOLD;
    getLength(): number;
    clone(): S2CurveOLD;
}

export class S2PolyCurveOLD implements S2CurveOLD {
    protected curves: S2CurveOLD[] = [];
    protected length: number = 0;
    protected cumulativeLengths: number[] = [];
    constructor() {}

    clone(): S2PolyCurveOLD {
        const polyCurve = new S2PolyCurveOLD();
    ...
    copy(other: S2PolyCurveOLD): this {
    ...
    getCurve(index: number): S2CurveOLD {
    ...
    addLine(p0: S2Vec2, p1: S2Vec2): this {
        const curve = new S2LineCurveOLD(p0, p1);
    ...
    addQuadratic(p0: S2Vec2, p1: S2Vec2, p2: S2Vec2, sampleCount: number = 0): this {
        const curve = new S2QuadraticCurveOLD(p0, p1, p2).computeLinearLUT(sampleCount);
    ...
    addCubic(p0: S2Vec2, p1: S2Vec2, p2: S2Vec2, p3: S2Vec2, sampleCount: number = 0): this {
        const curve = new S2CubicCurveOLD(p0, p1, p2, p3);
        if (sampleCount > 0) curve.computeLinearLUT(sampleCount);
        this.length += curve.getLength();
        this.curves.push(curve);
        return this;
    ...
    createPartialCurveTo(t: number): S2PolyCurveOLD {
        const partial = new S2PolyCurveOLD();
    ...
    createPartialCurveFrom(t: number): S2PolyCurveOLD {
        const partial = new S2PolyCurveOLD();
        if (this.curves.length === 0) return partial;
        const curveParam = this.getCurveParam(t);
    ...
    createPartialCurveRange(from: number, to: number): S2PolyCurveOLD {
        const partial = new S2PolyCurveOLD();
...
export class S2LineCurveOLD implements S2CurveOLD {
    public p0: S2Vec2;
    public p1: S2Vec2;
    ...
    copy(other: S2LineCurveOLD): this {
    ...
    clone(): S2CurveOLD {
        return new S2LineCurveOLD(this.p0, this.p1);
    }
    ...
    createPartialCurveTo(t: number): S2LineCurveOLD {
        return new S2LineCurveOLD(this.p0, this.getPointAt(t));
    }

    createPartialCurveFrom(t: number): S2LineCurveOLD {
        return new S2LineCurveOLD(this.getPointAt(t), this.p1);
    }

    createPartialCurveRange(from: number, to: number): S2LineCurveOLD {
        return new S2LineCurveOLD(this.getPointAt(from), this.getPointAt(to));
    }
}

abstract class S2BezierCurveOLD {
    protected points: S2Vec2[] = [];
    protected linearLUT: number[] | null = null;
    protected sampleCount: number = 0;
    protected length: number = 0;

    copy(other: S2BezierCurveOLD): this {
    ...
    abstract reduceToCasteljau(t: number): S2BezierCurveOLD;
    abstract reduceFromCasteljau(t: number): S2BezierCurveOLD;
    abstract makePartialCasteljau(from: number, to: number): S2BezierCurveOLD;
}

export class S2QuadraticCurveOLD extends S2BezierCurveOLD implements S2CurveOLD {
    ...
    clone(): S2QuadraticCurveOLD {
        const p = this.points;
        const curve = new S2QuadraticCurveOLD(p[0], p[1], p[2]);
        if (this.linearLUT) {
    ...
    reduceToCasteljau(t: number): S2QuadraticCurveOLD {
        ...
        return new S2QuadraticCurveOLD(this.points[0], q0, r0);
    }

    createPartialCurveTo(t: number): S2QuadraticCurveOLD {
        return this.reduceToCasteljau(this.linearize(t));
    }

    reduceFromCasteljau(t: number): S2QuadraticCurveOLD {
        const q0 = S2Vec2.lerpV(this.points[0], this.points[1], t);
        const q1 = S2Vec2.lerpV(this.points[1], this.points[2], t);
        const r0 = S2Vec2.lerpV(q0, q1, t);
        return new S2QuadraticCurveOLD(r0, q1, this.points[2]);
    }

    createPartialCurveFrom(t: number): S2QuadraticCurveOLD {
        return this.reduceFromCasteljau(this.linearize(t));
    }

    makePartialCasteljau(from: number, to: number): S2QuadraticCurveOLD {
        return this.reduceToCasteljau(to).reduceFromCasteljau(from / to);
    }

    createPartialCurveRange(from: number, to: number): S2QuadraticCurveOLD {
...
export class S2CubicCurveOLD extends S2BezierCurveOLD implements S2CurveOLD {
    ...
    clone(): S2CubicCurveOLD {
        const p = this.points;
        const cubicCurve = new S2CubicCurveOLD(p[0], p[1], p[2], p[3]);
        if (this.linearLUT) {
    ...
    reduceToCasteljau(t: number): S2CubicCurveOLD {
        const q0 = S2Vec2.lerpV(this.points[0], this.points[1], t);
        const q1 = S2Vec2.lerpV(this.points[1], this.points[2], t);
        ...
        return new S2CubicCurveOLD(this.points[0], q0, r0, s0);
    }

    createPartialCurveTo(t: number): S2CubicCurveOLD {
        return this.reduceToCasteljau(this.linearize(t));
    }

    reduceFromCasteljau(t: number): S2CubicCurveOLD {
        const q0 = S2Vec2.lerpV(this.points[0], this.points[1], t);
        const q1 = S2Vec2.lerpV(this.points[1], this.points[2], t);
        const q2 = S2Vec2.lerpV(this.points[2], this.points[3], t);
        const r0 = S2Vec2.lerpV(q0, q1, t);
        const r1 = S2Vec2.lerpV(q1, q2, t);
        const s0 = S2Vec2.lerpV(r0, r1, t);
        return new S2CubicCurveOLD(s0, r1, q2, this.points[3]);
    }

    createPartialCurveFrom(t: number): S2CubicCurveOLD {
        return this.reduceFromCasteljau(this.linearize(t));
    }

    makePartialCasteljau(from: number, to: number): S2CubicCurveOLD {
        return this.reduceToCasteljau(to).reduceFromCasteljau(from / to);
    }

    createPartialCurveRange(from: number, to: number): S2CubicCurveOLD {
        to = this.linearize(to);
        from = this.linearize(from);
        return this.reduceToCasteljau(to).reduceFromCasteljau(from / to);
    }
