...
import { NewS2Rect, S2Rect } from './s2-rect';
import { NewS2Circle, S2Circle } from './s2-circle';
...
import { NewS2TextGroup, NewS2TextLine, S2TextGroup, type S2TextAlign, type S2VerticalAlign } from './s2-text-group';
import { clamp } from '../math/s2-utils';
import { NewS2Line, S2Line } from './s2-line';
import { S2Animatable, S2Attributes } from '../s2-attributes';
import { S2Color } from '../s2-types';
import { NewS2Element, S2Element, S2LayerData, type S2BaseElement } from './s2-element';
import { NewS2Group, S2Group } from './s2-group';
...
export class NewS2Node extends NewS2Element<S2NodeData> {
    ...
    getPointInDirection(direction: S2Vec2, space: S2Space = this.data.position.space, distance: S2Length): S2Vec2 {
        if (this.background) {
