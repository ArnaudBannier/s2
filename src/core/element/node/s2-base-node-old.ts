...
import type { S2EdgeEndpointOLD } from './s2-edge-endpoint-old';
...
import { S2NodeDataOLD } from './s2-node-data-old';
import { S2Extents } from '../../shared/s2-extents';
import type { S2Space } from '../../math/s2-space';

export abstract class S2BaseNodeOLD extends S2Element<S2NodeDataOLD> {
    ...
    constructor(scene: S2BaseScene) {
        super(scene, new S2NodeDataOLD(scene));
