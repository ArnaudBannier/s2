...
// import { S2ExtentsOld } from '../../shared/s2-extents.ts';
...
//         if ('extents' in data && data.extents instanceof S2ExtentsOld) {
...
//         if ('minExtents' in data && data.minExtents instanceof S2ExtentsOld) {
...
//         if ('padding' in data && data.padding instanceof S2ExtentsOld) {
...
//         if ('steps' in data && data.steps instanceof S2ExtentsOld) {
