...
export class S2Extents extends S2BaseType implements S2HasClone<S2Extents>, S2HasCopy<S2Extents>, S2HasLerp<S2Extents> {
    ...
    set(x: number, y: number, space?: S2AbstractSpace): this {
    ...
    setV(extents: S2Vec2, space?: S2AbstractSpace): this {
    ...
    setValueFromSpaceV(extents: S2Vec2, space: S2AbstractSpace): this {
