...
import type { GraphDsaturScene } from './graph-dsatur-scene';

export class GraphDsaturNavigation {
    ...
    constructor(container: HTMLElement, scene: GraphDsaturScene, animator: S2StepAnimator) {
    ...
    init(): void {
        this.container.classList.add('graph-dsatur-navigation');
